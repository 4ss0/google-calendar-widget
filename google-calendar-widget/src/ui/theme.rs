...
pub struct AppTheme {
    ...
    pub event_bg_placeholder: Color,
}
...
impl AppTheme {
    pub fn light() -> Self {
        Self {
            ...
            surface: Color::from_rgba(0.99, 0.99, 1.0, 0.85),
            surface_alt: Color::from_rgba(0.90, 0.93, 0.97, 0.6),
            border: Color::from_rgba(0.62, 0.70, 0.80, 0.55),
            ...
            accent_soft: Color::from_rgba(0.28, 0.50, 0.78, 0.15),
            weekend_bg: Color::from_rgba(0.88, 0.92, 0.97, 0.5),
            ...
            event_bg_placeholder: Color::from_rgb(0.55, 0.55, 0.6),
        }
    }
    ...
    pub fn dark() -> Self {
        Self {
            ...
            surface: Color::from_rgba(0.08, 0.08, 0.10, 0.85),
            surface_alt: Color::from_rgba(0.12, 0.12, 0.15, 0.6),
            border: Color::from_rgba(0.25, 0.25, 0.32, 0.75),
            ...
            accent_soft: Color::from_rgba(0.42, 0.65, 0.92, 0.22),
            weekend_bg: Color::from_rgba(0.10, 0.10, 0.13, 0.55),
            ...
            event_bg_placeholder: Color::from_rgb(0.35, 0.35, 0.40),
        }
    }
}